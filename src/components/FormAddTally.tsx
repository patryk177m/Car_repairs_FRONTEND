...
export const FormAddTally = () => {
    ...
    return (
        <form className="form--container form global--container" onSubmit={onSubmit}>
            ...
            <input className="form__input" onChange={e => handleChange(e, setAddTally)} value={addTally?.replaced} type="text"
            ...
            <input className="form__input" onChange={e => handleChange(e, setAddTally)}
                   value={String(addTally?.date_replaced)} type="date" id="date_replaced" name="date_replaced" required/>
            ...
            <input className="form__input" onChange={e => handleChange(e, setAddTally)} value={addTally?.cost} type="text"
                   id="cost" name="cost" required/>

            <label className="form__label" htmlFor="service"> Gdzie naprawiano </label>
            <input className="form__input" onChange={e => handleChange(e, setAddTally)} value={addTally?.service} type="text"
                   id="service" name="service" required/>

            <label className="form__label" htmlFor="mechanic"> Imię mechanika </label>
            <input className="form__input" onChange={e => handleChange(e, setAddTally)} value={addTally?.mechanic} type="text"
            ...
            <input className="form__input" onChange={e => handleChange(e, setAddTally)} value={addTally?.current_mileage}
            ...
            <input className="form__input" onChange={e => handleChange(e, setAddTally)} value={addTally?.warranty_by_mileage}
